                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if(!isset($drt_amt) || !isset($drt_addr))
                                    <div class="row">  
                                        <div class="col-md-7">
                                            <div class="panel-body">

                                                <form class="form-horizontal" method="POST" role="form" action="{!! URL::route('drt.pay_drt_amt') !!}" >
                                                    @csrf
                                ...
                                @if(isset($drt_amt) && isset($drt_addr))                                   
                                    <div class="row">  
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-4">
                                                <a href="{{ url(auth()->user()->name .'/wallet')}}"  class="btn btn-primary">
                                                    {{ __('messages.bck') }}
                                                </a>                                                
                                            </div>
                                        </div>
